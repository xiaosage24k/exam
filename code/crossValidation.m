function [accuracy,clustering,cost_pot] = crossValidation( data, label, folds, options)
...
for i=1:folds         % 5次交叉验证
    ...
    %% calculate classification performance
     results = knnclassify(testDataArray', trainDataArray', trainLabel', 1);
     accuracy = accuracy + mean(results == testLabel)*100;
end
